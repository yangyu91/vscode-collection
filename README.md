...
## 💡 进阶插件推荐 (待添加)
以下是为您挑选的 PHP/HTML 进阶插件，如需添加请告知：
1. **PHP Debug**: 配合 Xdebug 进行断点调试。
2. **Live Server**: 编写 HTML 时，浏览器实时预览修改效果。
3. **PHP DocBlocker**: 快速生成标准的 PHP 函数注释。
4. **Bracket Pair Colorizer**: 用不同颜色区分嵌套的括号，防止看花眼。
